...
class Program {
    ...
    public void display() {                                
 	   int space=0;
	       ...
	       decpart.display(space+1);                                
	       body.display(space+1);                          
    }
}
...
// Declaration = Variable v; Type t
    ...
    public void display() {System.out.print("<"+v+","+t+">");}  
   ...
   public DefaultMutableTreeNode makeNode() {
	...
	public void display(int space) {
		...
		for(int i=0; i<members.size();i++)
			members.get(i).display(space+1);                             // 각 Statement 들에 대한 추상 구문 트리 출력 (display)
		}
...
class Assignment extends Statement {
	...
	public void display(int space) { 
		...
		target.display(space+1);                               
		source.display(space+1);                 
		}
...
// Conditional = Expression test; Statement thenbranch, elsebranch
   ...
   public DefaultMutableTreeNode makeNode() {
	...
	public void display(int space) { 
		...
		test.display(space+1);                      
		thenbranch.display(space+1);             
		elsebranch.display(space+1);               
	}
...
// Binary = Operator op; Expression term1, term2
   ...
   public DefaultMutableTreeNode makeNode() {
	...
	public void display (int space) {
		...
		op.display(space+1);                          
		term1.display(space+1);                    
		term2.display(space+1);                       
	}
}
...
class Operator {
    ...
    public void display(int space) {System.out.println(val);}
}
